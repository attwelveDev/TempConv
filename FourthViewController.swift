...
class FourthViewController: UIViewController, UIPickerViewDelegate, SideBarDelegate {
    ...
    @IBOutlet var tempRange: TemperatureRange2!
    @IBOutlet weak var tempPicker: UIPickerView!
    @IBOutlet weak var tempLabel: UILabel!
    
    fileprivate let converter = UnitConverter2()
