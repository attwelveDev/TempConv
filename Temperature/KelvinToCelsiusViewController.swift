//
//  KelvinToCelsiusViewController.swift
//  Temperature
//
...
class KelvinToCelsiusViewController: UIViewController, UIPickerViewDelegate, SideBarDelegate {
    ...
    @IBAction func kToF(_ sender: Any) {
        animateOut()
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = "K to C°"
        ...
        sideBar = SideBar(sourceView: self.view, menuItems: ["From C°", "From F°", "Help", "TempSave", "Learn", "More"])
    ...
    @IBOutlet var tempRange: TemperatureRange5!
    @IBOutlet weak var tempPicker: UIPickerView!
    @IBOutlet weak var tempLabel: UILabel!
    
    fileprivate let converter = kToCUnitConverter()
    ...
    func displayConvertedTemperatureForRow(_ row: Int){
        ...
        tempLabel.text = "\(converter.degreesCelsius(degreesKelvin))°C"
    }
